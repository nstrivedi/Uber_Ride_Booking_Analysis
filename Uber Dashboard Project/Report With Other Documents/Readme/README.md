...
![Dashboard](assets/screenshots/Services.png)
![Dashboard](assets/screenshots/Bookings.png)
![Dashboard](assets/screenshots/Revenue.png)
![Dashboard](assets/screenshots/TopPickupDrops.png)
![Dashboard](assets/screenshots/Payments.png)
...
- 🔄 Open: one narrative tile ("Top Payment") still reflects a slightly stale count and needs to be rebound to a live measure
